...
class CSP:
    def __init__(self):
        ...
        # Count the number of times the backtrack function is called
    ...
    def backtrack(self, assignment):
        ...
        if not var:
            for i in assignment:
                if len(assignment[i]) == 1:
                    ...
                    break
            if success:
                print("Number of backtracks " + str(self.backtrack_calls))
                print("Number of failures " + str(self.failures))
                return assignment
        ...
        for i in assignment[var]:
            ...
            new_inferences = self.inference(new_assignment, self.get_all_neighboring_arcs(var))
...
def print_sudoku_solution(solution: dict):
